...
#define MAX_FOOD_NUM 1200			//地图中最大豆子数量

#define MAP_DIVISION_X 3			//地图横向划分，3个屏幕宽大小
#define MAP_DIVISIOIN_Y 4			//地图纵向划分，4个屏幕高大小
#define MAP_DIVISION_FOOD_NUM 100			//每个划分区域的豆子数量

#define FOOD_SCORE  1		//每个豆子分值
#define FOOD_RADIUS 12			//豆子半径，单位像素
...
#define PRICK_SCORE 100			//绿刺初始分值
#define PRICK_RADIUS 62			//绿刺初始半径，单位像素
#define PRICK_SPLIT_DISTANCE 128			//碰到绿刺分裂出分身的距离

#define MIN_EAT_MULTIPLE 1.20			//游戏中吃的最小倍数
