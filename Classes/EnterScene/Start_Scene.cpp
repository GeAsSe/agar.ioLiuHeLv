...
bool Start_Scene::init()
{
	...
	auto color1 = MenuItemImage::create("BALL1.png", "BALLBUTTON.png", this, menu_selector(Start_Scene::put1));
	...
	auto color2 = MenuItemImage::create("BALL2.png", "BALLBUTTON.png", this, menu_selector(Start_Scene::put2));
	...
	auto color3 = MenuItemImage::create("BALL3.png", "BALLBUTTON.png", this, menu_selector(Start_Scene::put3));
	...
	auto color4 = MenuItemImage::create("BALL4.png", "BALLBUTTON.png", this, menu_selector(Start_Scene::put4));
